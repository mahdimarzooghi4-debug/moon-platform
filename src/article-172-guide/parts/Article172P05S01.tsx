...
export function Article172P05S01() {
  return (
      <div className="flex pt-[80px] pr-[120px] pb-[80px] pl-[120px] items-start self-stretch shrink-0 flex-nowrap bg-[#fff] relative z-[468]">
        <div className="flex pt-[32px] pr-[32px] pb-[32px] pl-[32px] flex-col gap-[24px] items-start grow shrink-0 basis-0 flex-nowrap bg-[#fcfbf8] rounded-[24px] border-solid border border-[#e4ebf1] relative shadow-[0_4px_16px_0_rgba(22,45,71,0.08)] z-[469]">
          <div className="flex gap-[12px] justify-end items-center self-stretch shrink-0 flex-nowrap relative z-[470]">
            <span className="flex w-[336px] h-[28px] justify-end items-start shrink-0 basis-auto font-['Vazirmatn'] text-[18px] font-bold leading-[28px] text-[#17324d] relative text-right whitespace-nowrap z-[471]">
          ...
          <span className="h-[22px] self-stretch shrink-0 basis-auto font-['Vazirmatn'] text-[14px] font-normal leading-[22px] text-[#60758a] relative text-right whitespace-nowrap z-[474]">
            به منظور کرامت انسانی و رعایت الزامات حقوقی، اسناد مالی و اطلاعات
          ...
          <div className="self-stretch shrink-0 relative z-[476]">
            <div className="flex w-[1136px] h-[22px] justify-between items-center relative z-[485]">
              <div className="flex gap-[10px] justify-end items-center grow shrink-0 basis-0 flex-nowrap relative z-[477]">
                <span className="h-[22px] grow shrink-0 basis-auto font-['Vazirmatn'] text-[14px] font-normal leading-[21.875px] text-[#60758a] relative text-right whitespace-nowrap z-[478]">
              ...
              <div className="flex gap-[10px] justify-end items-center grow shrink-0 basis-0 flex-nowrap relative z-[481]">
                <span className="h-[22px] grow shrink-0 basis-auto font-['Vazirmatn'] text-[14px] font-normal leading-[21.875px] text-[#60758a] relative text-right whitespace-nowrap z-[482]">
              ...
              <div className="flex gap-[10px] justify-end items-center grow shrink-0 basis-0 flex-nowrap relative z-[485]">
                <span className="h-[22px] grow shrink-0 basis-auto font-['Vazirmatn'] text-[14px] font-normal leading-[21.875px] text-[#60758a] relative text-right whitespace-nowrap z-[486]">
            ...
            <div className="flex w-[1136px] h-[22px] justify-between items-center relative z-[497]">
              <div className="flex gap-[10px] justify-end items-center grow shrink-0 basis-0 flex-nowrap relative z-[489]">
                <span className="h-[22px] grow shrink-0 basis-auto font-['Vazirmatn'] text-[14px] font-normal leading-[21.875px] text-[#60758a] relative text-right whitespace-nowrap z-[490]">
              ...
              <div className="flex gap-[10px] justify-end items-center grow shrink-0 basis-0 flex-nowrap relative z-[493]">
                <span className="h-[22px] grow shrink-0 basis-auto font-['Vazirmatn'] text-[14px] font-normal leading-[21.875px] text-[#60758a] relative text-right whitespace-nowrap z-[494]">
              ...
              <div className="flex gap-[10px] justify-end items-center grow shrink-0 basis-0 flex-nowrap relative z-[497]">
                <span className="h-[22px] grow shrink-0 basis-auto font-['Vazirmatn'] text-[14px] font-normal leading-[21.875px] text-[#60758a] relative text-right whitespace-nowrap z-[498]">
            ...
            <div className="flex w-[1136px] h-[22px] justify-between items-center relative z-[509]">
              <div className="flex gap-[10px] justify-end items-center grow shrink-0 basis-0 flex-nowrap relative z-[501]">
                <span className="h-[22px] grow shrink-0 basis-auto font-['Vazirmatn'] text-[14px] font-normal leading-[21.875px] text-[#60758a] relative text-right whitespace-nowrap z-[502]">
              ...
              <div className="flex gap-[10px] justify-end items-center grow shrink-0 basis-0 flex-nowrap relative z-[505]">
                <span className="h-[22px] grow shrink-0 basis-auto font-['Vazirmatn'] text-[14px] font-normal leading-[21.875px] text-[#60758a] relative text-right whitespace-nowrap z-[506]">
              ...
              <div className="flex gap-[10px] justify-end items-center grow shrink-0 basis-0 flex-nowrap relative z-[509]">
                <span className="h-[22px] grow shrink-0 basis-auto font-['Vazirmatn'] text-[14px] font-normal leading-[21.875px] text-[#60758a] relative text-right whitespace-nowrap z-[510]">
