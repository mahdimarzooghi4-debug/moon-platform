...
export function Article172P02S02() {
  return (
      <div className="flex pt-[80px] pr-[120px] pb-[80px] pl-[120px] flex-col gap-[40px] items-start self-stretch shrink-0 flex-nowrap relative z-[89]">
        <div className="flex flex-col gap-[12px] items-center self-stretch shrink-0 flex-nowrap relative z-[90]">
          <span className="flex w-[361px] h-[44px] justify-center items-start shrink-0 basis-auto font-['Vazirmatn'] text-[28px] font-extrabold leading-[43.75px] text-[#17324d] relative text-center whitespace-nowrap z-[91]">
            این راهنما برای چه کسانی است؟
          </span>
          <span className="h-[23px] self-stretch shrink-0 basis-auto font-['Vazirmatn'] text-[15px] font-normal leading-[23px] text-[#60758a] relative text-center whitespace-nowrap z-[92]">
            تفکیک دامنه مشمولان و مواردی که خارج از فرآیند بررسی گواهی هستند
          </span>
        </div>
        <div className="flex gap-[32px] items-start self-stretch shrink-0 flex-nowrap relative z-[93]">
          <div className="flex pt-[32px] pr-[32px] pb-[32px] pl-[32px] flex-col gap-[24px] items-start grow shrink-0 basis-0 flex-nowrap bg-[#fff] rounded-[24px] border-solid border border-[#e4ebf1] relative shadow-[0_4px_16px_0_rgba(22,45,71,0.08)] z-[94]">
            <div className="flex gap-[8px] justify-end items-center self-stretch shrink-0 flex-nowrap relative z-[95]">
              <span className="flex w-[160px] h-[28px] justify-end items-start shrink-0 basis-auto font-['Vazirmatn'] text-[18px] font-bold leading-[28px] text-[#17324d] relative text-right whitespace-nowrap z-[96]">
                شامل این موارد نیست
              </span>
          ...
          <div className="flex pt-[32px] pr-[32px] pb-[32px] pl-[32px] flex-col gap-[24px] items-start grow shrink-0 basis-0 flex-nowrap bg-[#fff] rounded-[24px] border-solid border border-[#e4ebf1] relative shadow-[0_4px_16px_0_rgba(22,45,71,0.08)] z-[116]">
            <div className="flex gap-[8px] justify-end items-center self-stretch shrink-0 flex-nowrap relative z-[117]">
              <span className="flex w-[86px] h-[28px] justify-end items-start shrink-0 basis-auto font-['Vazirmatn'] text-[18px] font-bold leading-[28px] text-[#17324d] relative text-right whitespace-nowrap z-[118]">
                مناسب برای
              </span>
