  ...
  return (
    <section className="flex w-full flex-col gap-5 rounded-3xl border border-[#e4ebf1] bg-white p-8 text-right shadow-[0_4px_16px_rgba(23,46,71,0.08)]" dir="rtl">
      <div className="flex w-full flex-col items-start gap-2 text-right">
        <h1 className="m-0 w-full text-right text-[20px] font-extrabold leading-[31px]">۱. تأیید اطلاعات و شماره موبایل</h1>
        <p className="m-0 w-full text-right text-[14px] leading-[22px] text-[#60758a]">برای ثبت رسمی و امکان پیگیری نتایج مشارکت، لطفاً شماره موبایل خود را تأیید کنید. نیازی به ایجاد حساب کاربری کامل نیست.</p>
      </div>
      <div className="h-px w-full bg-[#e4ebf1]" />

      <div className="flex w-full items-start gap-6" dir="ltr">
        <div className="flex w-[355px] shrink-0 flex-col items-start gap-4 rounded-2xl border border-[#2094e3] bg-[#fcfbf8] p-6 text-right" dir="rtl">
          <div className="flex w-full flex-col items-start gap-1 text-right">
            <strong className="w-full text-right text-[14px]">کد تأیید را وارد کنید</strong>
            <span className="w-full text-right text-[12px] text-[#60758a]">کد یک‌بارمصرف به شماره {maskedPhone} ارسال شد.</span>
          </div>
        ...
        <div className="flex w-[355px] shrink-0 flex-col items-start gap-4 text-right" dir="rtl">
          <div className="flex w-full flex-col items-start gap-2 text-right">
            <label htmlFor="individual-phone" className="w-full text-right text-[14px] font-bold">شماره موبایل</label>
          ...
          {verified && (
            <div className="flex w-full items-center justify-start gap-3 rounded-xl bg-[#eaf8f0] p-3 text-right" dir="rtl">
              ...
              <span className="text-[13px] font-medium text-[#17324d]" dir="ltr">{phoneFa}</span>
      ...
      <div className="flex w-full flex-col items-start gap-2 pt-3 text-right" dir="rtl">
        <label htmlFor="participant-name" className="w-full text-right text-[14px] font-bold">نام و نام خانوادگی مشارکت‌کننده</label>
        <span className="w-full text-right text-[12px] text-[#60758a]">در صورت تمایل، نام خود را برای درج در رسید مشارکت و تابلوی همراهان پروژه وارد کنید.</span>
        <input id="participant-name" value={name} onChange={(event) => setName(event.target.value)} placeholder="مثلاً مریم احمدی" className="w-full rounded-xl border border-[#e4ebf1] bg-[#fcfbf8] p-3.5 text-right text-[14px] text-[#17324d] placeholder:text-[#60758a]" dir="rtl" />
      </div>
    </section>
  );
}
