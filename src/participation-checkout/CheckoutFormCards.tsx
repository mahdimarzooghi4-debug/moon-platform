    ...
    <>
      <section className="flex w-full flex-col gap-5 rounded-3xl border border-[#e4ebf1] bg-white p-8 text-right shadow-[0_4px_16px_rgba(23,46,71,0.08)]" dir="rtl">
        <div className="flex w-full items-center justify-between" dir="ltr">
          ...
          <h2 className="m-0 text-[20px] font-extrabold leading-[31px]" dir="rtl">۲. مبلغ و مسیر مصرف منابع</h2>
        </div>
        ...
        <div className="flex flex-col items-end gap-3">
          <strong className="text-[14px]">مشارکت شما به کجا اختصاص می‌یابد؟</strong>
          <p className="m-0 text-[13px] leading-[22px] text-[#60758a]">این مبلغ به صورت مستقیم برای طرح اشتغال زنان روستایی سیستان و گلستان ثبت می‌شود و به حساب تحت نظارت کمیته امداد واریز خواهد شد. پرداخت منابع به استارتاپ مجری پروژه (راهکار سبز) به صورت مرحله‌ای و منوط به تأیید شاخص‌های اثر اجتماعی (KPI) هر مرحله توسط خانه خلاق است.</p>
          <button type="button" onClick={onHowItWorks} className="cursor-pointer border-0 bg-transparent p-0 text-[13px] text-[#2094e3] underline">آشنایی با مسیر پایش منابع در ماه ←</button>
        </div>
      </section>
      ...
      <section className="flex w-full flex-col gap-5 rounded-3xl border border-[#e4ebf1] bg-white p-8 shadow-[0_4px_16px_rgba(23,46,71,0.08)]" dir="rtl">
        ...
        <div className="flex flex-col gap-4">
          <div className="flex w-full items-start justify-end gap-3">
            <div className="flex min-w-0 flex-1 flex-col items-end gap-0.5 text-right">
              <p className="m-0 w-full text-[13px] leading-[22px]">شرایط استفاده و قوانین مشارکت در سامانه ماه را مطالعه کرده و می‌پذیرم.</p>
              <button type="button" onClick={onTerms} className="cursor-pointer border-0 bg-transparent p-0 text-[12px] text-[#2094e3] underline">مطالعه شرایط استفاده و قوانین</button>
            </div>
        ...
        <div className="flex w-full items-center justify-end gap-1.5 text-[12px] text-[#60758a]">
        ...
        <div className="flex w-full flex-col items-center gap-4">
          ...
          <p className="m-0 text-center text-[12px] text-[#60758a]">با کلیک روی این دکمه به درگاه رسمی پرداخت متصل به حساب کمیته امداد منتقل می‌شوید.</p>
