  ...
  return (
    <footer className="flex w-full flex-col gap-16 bg-[#111e30] px-[120px] pb-10 pt-20 text-right" dir="ltr">
      <div className="flex w-full items-start gap-12">
        ...
        <div className="flex h-[182px] w-[150px] flex-col items-end gap-3" dir="rtl"><strong className="text-[14px] text-white">حقوقی</strong><FooterButton onClick={() => navigateTo("/terms")}>قوانین و مقررات</FooterButton><FooterButton onClick={() => navigateTo("/privacy")}>حریم خصوصی</FooterButton></div>
        ...
        <div className="flex w-[180px] flex-col items-end gap-3" dir="rtl"><strong className="text-[14px] text-white">دسترسی سریع</strong><FooterButton onClick={() => navigateTo("/projects")}>پروژه‌ها</FooterButton><FooterButton onClick={() => navigateTo("/companies")}>برای شرکت‌ها</FooterButton><FooterButton onClick={() => navigateTo("/how-it-works")}>نحوه مشارکت</FooterButton><FooterButton onClick={() => navigateTo("/startups/register")}>ثبت‌نام استارتاپ</FooterButton><FooterButton onClick={() => navigateTo("/events")}>اخبار و رویدادها</FooterButton></div>
