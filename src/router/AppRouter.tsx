...
const FundManagerFundingFlowControlPage = lazy(() => import("../panels/fund-manager/funding-flow-control"));
const FundManagerActionOverlay = lazy(() => import("../panels/fund-manager/overlays/action"));
const FundManagerPaginationOverlay = lazy(() => import("../panels/fund-manager/overlays/pagination"));
const FundManagerLogoutOverlay = lazy(() => import("../panels/fund-manager/overlays/logout"));
...
const fundManagerResourceDetailElement = lazyElement(FundManagerResourceDetailPage);
const fundManagerInvestmentsElement = lazyElement(FundManagerInvestmentsPage);
const fundManagerInvestmentDetailElement = lazyElement(FundManagerInvestmentDetailPage);
const fundManagerProfitReturnsElement = lazyElement(FundManagerProfitReturnsPage);
const fundManagerProfitReturnDetailElement = lazyElement(FundManagerProfitReturnDetailPage);
const fundManagerCycleReturnsElement = lazyElement(FundManagerCycleReturnsPage);
...
const fundManagerReportDetailElement = lazyElement(FundManagerReportDetailPage);
const fundManagerFinancialHistoryElement = lazyElement(FundManagerFinancialHistoryPage);
const fundManagerFinancialHistoryDetailElement = lazyElement(FundManagerFinancialHistoryDetailPage);
const fundManagerFundingFlowControlElement = lazyElement(FundManagerFundingFlowControlPage);
const fundManagerActionOverlayElement = lazyElement(FundManagerActionOverlay);
const fundManagerPaginationOverlayElement = lazyElement(FundManagerPaginationOverlay);
const fundManagerLogoutOverlayElement = lazyElement(FundManagerLogoutOverlay);
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/panel/fund-manager/resources/detail" element={fundManagerResourceDetailElement} />
        <Route path="/panel/fund-manager/investments" element={fundManagerInvestmentsElement} />
        <Route path="/panel/fund-manager/investments/detail" element={fundManagerInvestmentDetailElement} />
        <Route path="/panel/fund-manager/profit-returns" element={fundManagerProfitReturnsElement} />
        <Route path="/panel/fund-manager/profit-returns/detail" element={fundManagerProfitReturnDetailElement} />
        <Route path="/panel/fund-manager/cycle-returns" element={fundManagerCycleReturnsElement} />
        ...
        <Route path="/panel/fund-manager/reports/detail" element={fundManagerReportDetailElement} />
        <Route path="/panel/fund-manager/financial-history" element={fundManagerFinancialHistoryElement} />
        <Route path="/panel/fund-manager/financial-history/detail" element={fundManagerFinancialHistoryDetailElement} />
        <Route path="/panel/fund-manager/funding-flow-control" element={fundManagerFundingFlowControlElement} />
        <Route path="/panel/fund-manager/overlays/action" element={fundManagerActionOverlayElement} />
        <Route path="/panel/fund-manager/overlays/pagination" element={fundManagerPaginationOverlayElement} />
        <Route path="/panel/fund-manager/overlays/logout" element={fundManagerLogoutOverlayElement} />
