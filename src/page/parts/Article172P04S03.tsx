...
export function Article172P04S03() {
  return (
      <div className="flex pt-[80px] pr-[120px] pb-[80px] pl-[120px] flex-col gap-[40px] items-start self-stretch shrink-0 flex-nowrap bg-[#fff] relative z-[410]">
        <div className="flex flex-col gap-[12px] items-center self-stretch shrink-0 flex-nowrap relative z-[411]">
          <span className="flex w-[390px] h-[44px] justify-center items-start shrink-0 basis-auto font-['Vazirmatn'] text-[28px] font-extrabold leading-[43.75px] text-[#17324d] relative text-center whitespace-nowrap z-[412]">
          ...
          <span className="h-[23px] self-stretch shrink-0 basis-auto font-['Vazirmatn'] text-[15px] font-normal leading-[23px] text-[#60758a] relative text-center whitespace-nowrap z-[413]">
            مسئولیت‌ها، زیرساخت فناوری و ابزارهای پایش آنلاین ارائه شده در
            پلتفرم
          </span>
        </div>
        <div className="self-stretch shrink-0 relative z-[414]">
          <div className="flex w-[1200px] h-[174px] justify-between items-center relative z-[421]">
            <div className="flex pt-[24px] pr-[24px] pb-[24px] pl-[24px] flex-col gap-[16px] items-end grow shrink-0 basis-0 flex-nowrap bg-[#fcfbf8] rounded-[16px] border-solid border border-[#e4ebf1] relative shadow-[0_4px_16px_0_rgba(22,45,71,0.08)] z-[415]">
              ...
              <span className="h-[22px] self-stretch shrink-0 basis-auto font-['Vazirmatn'] text-[14px] font-normal leading-[22px] text-[#60758a] relative text-right whitespace-nowrap z-[420]">
                امکان دانلود اسناد سنجش عملکرد، تصاویر اجرایی و مستندات فیزیکی
                تایید شده توسط ناظران
              </span>
            </div>
            <div className="flex pt-[24px] pr-[24px] pb-[24px] pl-[24px] flex-col gap-[16px] items-end grow shrink-0 basis-0 flex-nowrap bg-[#fcfbf8] rounded-[16px] border-solid border border-[#e4ebf1] relative shadow-[0_4px_16px_0_rgba(22,45,71,0.08)] z-[421]">
              ...
              <span className="flex w-[169px] h-[28px] justify-end items-start shrink-0 basis-auto font-['Vazirmatn'] text-[18px] font-bold leading-[28px] text-[#17324d] relative text-right whitespace-nowrap z-[425]">
                نگهداری مستندات مجاز
              </span>
              <span className="h-[22px] self-stretch shrink-0 basis-auto font-['Vazirmatn'] text-[14px] font-normal leading-[22px] text-[#60758a] relative text-right whitespace-nowrap z-[426]">
                آرشیو امن رسیدها، فیش‌های بانکی و سوابق هویتی به صورت یکپارچه
                برای ارائه گزارش‌های سالانه
              </span>
            </div>
          </div>
          <div className="flex w-[1200px] h-[174px] justify-between items-center relative z-[433]">
            <div className="flex pt-[24px] pr-[24px] pb-[24px] pl-[24px] flex-col gap-[16px] items-end grow shrink-0 basis-0 flex-nowrap bg-[#fcfbf8] rounded-[16px] border-solid border border-[#e4ebf1] relative shadow-[0_4px_16px_0_rgba(22,45,71,0.08)] z-[427]">
              ...
              <span className="h-[22px] self-stretch shrink-0 basis-auto font-['Vazirmatn'] text-[14px] font-normal leading-[22px] text-[#60758a] relative text-right whitespace-nowrap z-[432]">
                پیگیری گام‌به‌گام و مانیتورینگ روند گردش کار کارشناسی مدارک در
                بستر سامانه
              </span>
            </div>
            <div className="flex pt-[24px] pr-[24px] pb-[24px] pl-[24px] flex-col gap-[16px] items-end grow shrink-0 basis-0 flex-nowrap bg-[#fcfbf8] rounded-[16px] border-solid border border-[#e4ebf1] relative shadow-[0_4px_16px_0_rgba(22,45,71,0.08)] z-[433]">
              ...
              <span className="h-[22px] self-stretch shrink-0 basis-auto font-['Vazirmatn'] text-[14px] font-normal leading-[22px] text-[#60758a] relative text-right whitespace-nowrap z-[438]">
                ارائه ساختار شفاف برای مستندسازی نیت مشارکت و تسهیل ارتباط شرکت
                با جامعه هدف
              </span>
            </div>
          </div>
        </div>
        <span className="h-[22px] self-stretch shrink-0 basis-auto font-['Vazirmatn'] text-[14px] font-bold leading-[21.875px] text-[#2094e3] relative text-center whitespace-nowrap z-[439]">
          ℹ سامانه ماه مشاور مالیاتی، مرجع تشخیص مالیات یا صادرکننده تضمینی
          گواهی نیست.
        </span>
      </div>
  );
