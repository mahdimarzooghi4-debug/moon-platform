      ...
      <div className="flex h-[80px] pt-0 pr-[120px] pb-0 pl-[120px] justify-between items-center self-stretch shrink-0 flex-nowrap bg-[#fff] border-solid border-t border-t-[#e8e8e8] relative">
        <div className="flex w-[150px] gap-[8px] items-center shrink-0 flex-nowrap relative z-[1]">
          <div className="flex w-[16px] h-[16px] flex-col justify-center items-center shrink-0 flex-nowrap relative overflow-hidden z-[2]">
            <div className="w-[16px] h-[16px] shrink-0 bg-[url(/assets/1M6r021j9U.png)] bg-cover bg-no-repeat relative overflow-hidden z-[3]" />
          </div>
        ...
        <div className="flex w-[137px] gap-[12px] items-center shrink-0 flex-nowrap relative z-[5]">
          <div className="w-[137px] h-[46px] shrink-0 bg-[url(/assets/YccaNps5AJ.png)] bg-cover bg-no-repeat relative z-[6]" />
        </div>
      </div>
      <div className="flex pt-[48px] pr-0 pb-[48px] pl-0 flex-col items-center self-stretch shrink-0 flex-nowrap relative z-[7]">
        <div className="flex w-[540px] pt-[36px] pr-[36px] pb-[36px] pl-[36px] flex-col gap-[24px] items-center shrink-0 flex-nowrap bg-[#fff] rounded-[20px] border-solid border border-[#e4ebf1] relative shadow-[0_4px_20px_0_rgba(0,0,0,0.04)] z-[8]">
          <div className="flex w-[64px] h-[64px] justify-center items-center shrink-0 flex-nowrap bg-[#eaf5fd] rounded-[32px] relative z-[9]">
            <div className="w-[28px] h-[28px] shrink-0 bg-[url(/assets/r3LkYver1w.png)] bg-cover bg-no-repeat relative overflow-hidden z-10" />
          </div>
          ...
          <div dir="ltr" className="flex gap-[12px] justify-center items-start self-stretch shrink-0 flex-nowrap relative z-[17]">
            ...
            <div className="flex w-[52px] h-[56px] justify-center items-center shrink-0 flex-nowrap bg-[#fff] rounded-[12px] border-solid border-2 border-[#2094e3] relative z-20">
          ...
          <div className="flex pt-[16px] pr-0 pb-0 pl-0 flex-col gap-[8px] items-center self-stretch shrink-0 flex-nowrap relative z-[31]">
            <div className="flex w-[283px] gap-[6px] items-center shrink-0 flex-nowrap relative z-[32]">
              <span className="flex w-[263px] h-[19px] justify-center items-start shrink-0 basis-auto font-['Vazirmatn'] text-[12px] font-normal leading-[18.75px] text-[#718096] relative text-center whitespace-nowrap z-[33]">
                کد تأیید محرمانه است؛ آن را در اختیار دیگران قرار ندهید.
              </span>
              <div className="w-[14px] h-[14px] shrink-0 bg-[url(/assets/Cu2QHWVDxE.png)] bg-cover bg-no-repeat relative overflow-hidden z-[34]" />
            </div>
            <span className="flex w-[250px] h-[17px] justify-center items-start shrink-0 basis-auto font-['Vazirmatn'] text-[11px] font-normal leading-[17px] text-[#a0aec0] relative text-center whitespace-nowrap z-[35]">
              ورود شما با کد یک‌بارمصرف و بدون رمز عبور انجام می‌شود.
            </span>
          </div>
        </div>
      </div>
      <div className="flex pt-[24px] pr-0 pb-[40px] pl-0 flex-col gap-[12px] items-center self-stretch shrink-0 flex-nowrap relative z-[36]">
        <span className="flex w-[347px] h-[19px] justify-center items-start shrink-0 basis-auto font-['Vazirmatn'] text-[12px] font-normal leading-[18.75px] text-[#a0aec0] relative text-center whitespace-nowrap z-[37]">
          اطلاعات شما مطابق سیاست حریم خصوصی سامانه ماه محافظت می‌شود.
        </span>
        <div className="flex w-[180px] gap-[16px] items-center shrink-0 flex-nowrap relative z-[38]">
          <span className="flex w-[76px] h-[19px] justify-end items-start shrink-0 basis-auto font-['Vazirmatn'] text-[12px] font-normal leading-[18.75px] text-[#718096] relative text-right whitespace-nowrap z-[39]">
            قوانین و مقررات
          </span>
          <span className="h-[19px] shrink-0 basis-auto font-['Vazirmatn'] text-[12px] font-normal leading-[18.75px] text-[#93a3b7] relative text-left whitespace-nowrap z-40">
            |
          </span>
          <span className="flex w-[69px] h-[19px] justify-end items-start shrink-0 basis-auto font-['Vazirmatn'] text-[12px] font-normal leading-[18.75px] text-[#718096] relative text-right whitespace-nowrap z-[41]">
            حریم خصوصی
          </span>
        </div>
      </div>
