  ...
  return (
    <div dir="ltr" className="main-container mx-auto flex h-[1100px] w-[1440px] flex-nowrap items-start bg-[#f4f6f8]">
      <main className="flex h-[1100px] min-w-0 flex-1 flex-col items-start gap-[24px] px-[40px] pb-[40px] pt-[24px]">
        ...
        <section className="flex w-full shrink-0 flex-col items-start rounded-[16px] border border-[#e4ebf1] bg-white p-[16px]">
          <div className="flex w-full flex-wrap content-center items-center gap-[10px]">
            <div className="flex shrink-0 items-center gap-[16px]">
              <button type="button" className="whitespace-nowrap text-right text-[13px] font-normal leading-[20px] text-[#2094e3] underline underline-offset-[2px]" dir="rtl">پاک‌کردن فیلترها</button>
              <div className="flex shrink-0 items-center rounded-[8px] bg-[#fee2e2] px-[10px] py-[6px]">
                <span dir="rtl" className="whitespace-nowrap text-right text-[12px] font-bold leading-[19px] text-[#ef4444]">وضعیت: مسدودشده</span>
              </div>
              <div className="flex shrink-0 items-center rounded-[8px] bg-[#eaf5fd] px-[10px] py-[6px]">
                <span dir="rtl" className="whitespace-nowrap text-right text-[12px] font-bold leading-[19px] text-[#2094e3]">نوع: ویدئو</span>
              </div>
              <span dir="rtl" className="whitespace-nowrap text-right text-[13px] font-normal leading-[20px] text-[#60758a]">۰ رسانه یافت شد</span>
            </div>
        ...
        <section className="flex min-h-[500px] w-full min-w-0 flex-1 flex-col items-center justify-center gap-[20px] rounded-[20px] border border-[#e4ebf1] bg-white p-[48px]" style={{ boxShadow: "0 4px 16px rgba(23, 46, 71, 0.08)" }}>
          <div className="flex size-[80px] shrink-0 items-center justify-center rounded-full bg-[#f4f6f8]">
            <img src="/assets/mah/media-no-results-search.svg" alt="" className="size-[40px]" />
          </div>
          <h2 dir="rtl" className="whitespace-nowrap text-right text-[20px] font-bold leading-[31px] text-[#17324d]">رسانه‌ای مطابق جست‌وجو یا فیلترها پیدا نشد</h2>
          <p dir="rtl" className="whitespace-nowrap text-center text-[14px] font-normal leading-[22px] text-[#60758a]">تغییری در فیلترها یا عبارت جست‌وجو ایجاد کنید و مجدداً تلاش نمایید.</p>
          <MahButton label="پاک‌کردن فیلترها" />
        </section>
      </main>
