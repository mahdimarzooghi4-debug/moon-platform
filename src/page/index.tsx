      ...
      <div className="flex h-[80px] pt-0 pr-[120px] pb-0 pl-[120px] justify-between items-center self-stretch shrink-0 flex-nowrap bg-[#fff] border-solid border-t border-t-[#e5eaf2] relative">
        <div className="flex w-[154px] gap-[8px] justify-center items-center shrink-0 flex-nowrap relative z-[1]">
          <div className="flex w-[16px] h-[16px] flex-col justify-center items-center shrink-0 flex-nowrap relative overflow-hidden z-[2]">
            <div className="w-[16px] h-[16px] shrink-0 bg-[url(https://static.codia.ai/image/2026-08-24/RMq7Pxr4Gq.png)] bg-cover bg-no-repeat relative overflow-hidden z-[3]" />
          </div>
        ...
        <div className="flex w-[137px] gap-[12px] items-center shrink-0 flex-nowrap relative z-[5]">
          <div className="w-[137px] h-[46px] shrink-0 bg-[url(https://static.codia.ai/image/2026-08-24/raiv8rhiui.png)] bg-cover bg-no-repeat relative z-[6]" />
        </div>
      </div>
      <div className="flex pt-[48px] pr-0 pb-[48px] pl-0 flex-col items-center self-stretch shrink-0 flex-nowrap relative z-[7]">
        <div className="flex w-[780px] pt-[36px] pr-[36px] pb-[36px] pl-[36px] flex-col gap-[28px] items-end shrink-0 flex-nowrap bg-[#fff] rounded-[20px] border-solid border border-[#e4ebf1] relative z-[8]">
          <div className="flex justify-between items-center self-stretch shrink-0 flex-nowrap relative z-[9]">
            <div className="flex w-[161px] pt-[4px] pr-[10px] pb-[4px] pl-[10px] gap-[6px] items-center shrink-0 flex-nowrap bg-[#eaf8f0] rounded-[8px] relative z-10">
              ...
              <div className="flex w-[14px] h-[14px] flex-col justify-center items-center shrink-0 flex-nowrap relative overflow-hidden z-[12]">
                <div className="w-[14px] h-[14px] shrink-0 bg-[url(https://static.codia.ai/image/2026-08-24/z7n6RfhNyw.png)] bg-cover bg-no-repeat relative overflow-hidden z-[13]" />
              </div>
            </div>
            ...
            <div className="flex h-[180px] pt-[16px] pr-[16px] pb-[16px] pl-[16px] flex-col gap-[12px] items-end grow shrink-0 basis-0 flex-nowrap bg-[#fff] rounded-[12px] border-solid border border-[#e4ebf1] relative z-[18]">
              <div className="flex justify-between items-center self-stretch shrink-0 flex-nowrap relative z-[19]">
                ...
                <div className="flex w-[40px] h-[40px] justify-center items-center shrink-0 flex-nowrap bg-[#f7fafc] rounded-[8px] relative z-[21]">
                  <div className="flex w-[22px] h-[22px] flex-col justify-center items-center shrink-0 flex-nowrap relative overflow-hidden z-[22]">
                    <div className="w-[22px] h-[22px] shrink-0 bg-[url(https://static.codia.ai/image/2026-08-24/ViHSBZYuHG.png)] bg-cover bg-no-repeat relative overflow-hidden z-[23]" />
                  </div>
                </div>
              </div>
              ...
              <span className="flex w-[192.667px] h-[36px] justify-end items-start self-stretch shrink-0 font-['Vazirmatn'] text-[12px] font-normal leading-[18px] text-[#718096] relative text-right z-[25]">
            ...
            <div className="flex h-[180px] pt-[16px] pr-[16px] pb-[16px] pl-[16px] flex-col gap-[12px] items-end grow shrink-0 basis-0 flex-nowrap bg-[#fff] rounded-[12px] border-solid border border-[#e4ebf1] relative z-[26]">
              <div className="flex justify-between items-center self-stretch shrink-0 flex-nowrap relative z-[27]">
                ...
                <div className="flex w-[40px] h-[40px] justify-center items-center shrink-0 flex-nowrap bg-[#f7fafc] rounded-[8px] relative z-[29]">
                  <div className="flex w-[22px] h-[22px] flex-col justify-center items-center shrink-0 flex-nowrap relative overflow-hidden z-30">
                    <div className="w-[22px] h-[22px] shrink-0 bg-[url(https://static.codia.ai/image/2026-08-24/oLoBM0yGds.png)] bg-cover bg-no-repeat relative overflow-hidden z-[31]" />
                  </div>
                </div>
              </div>
              ...
              <span className="flex w-[192.667px] h-[36px] justify-end items-start self-stretch shrink-0 font-['Vazirmatn'] text-[12px] font-normal leading-[18px] text-[#718096] relative text-right z-[33]">
                ثبت پروژه، پیگیری ارزیابی، KPI و تأمین مالی
              </span>
            </div>
            <div className="flex h-[180px] pt-[16px] pr-[16px] pb-[16px] pl-[16px] flex-col gap-[12px] items-end grow shrink-0 basis-0 flex-nowrap bg-[#eaf5fd] rounded-[12px] border-solid border-2 border-[#2094e3] relative z-[34]">
              <div className="flex justify-between items-center self-stretch shrink-0 flex-nowrap relative z-[35]">
                <div className="flex w-[18px] h-[18px] items-start shrink-0 flex-nowrap bg-[#fff] rounded-[9px] border-solid border-[5px] border-[#2094e3] relative z-[36]" />
                <div className="flex w-[40px] h-[40px] justify-center items-center shrink-0 flex-nowrap bg-[rgba(32,148,227,0.08)] rounded-[8px] relative z-[37]">
                  <div className="flex w-[22px] h-[22px] flex-col justify-center items-center shrink-0 flex-nowrap relative overflow-hidden z-[38]">
                    <div className="w-[22px] h-[22px] shrink-0 bg-[url(https://static.codia.ai/image/2026-08-24/87vfMyeBqJ.png)] bg-cover bg-no-repeat relative overflow-hidden z-[39]" />
                  </div>
                </div>
              </div>
              ...
              <span className="flex w-[194.667px] h-[36px] justify-end items-start self-stretch shrink-0 font-['Vazirmatn'] text-[12px] font-normal leading-[18px] text-[#718096] relative text-right z-[41]">
          ...
          <div className="flex flex-col gap-[8px] items-end self-stretch shrink-0 flex-nowrap relative z-[42]">
            ...
            <div className="flex h-[48px] pt-0 pr-[16px] pb-0 pl-[16px] gap-[8px] justify-end items-center self-stretch shrink-0 flex-nowrap bg-[#fff] rounded-[12px] border-solid border-2 border-[#2094e3] relative z-[44]">
              ...
              <div className="flex w-[18px] h-[18px] flex-col justify-center items-center shrink-0 flex-nowrap relative overflow-hidden z-[46]">
                <div className="w-[18px] h-[18px] shrink-0 bg-[url(https://static.codia.ai/image/2026-08-24/xjjEr1MMBV.png)] bg-cover bg-no-repeat relative overflow-hidden z-[47]" />
              </div>
            </div>
          ...
          <div className="flex h-[50px] justify-center items-center self-stretch shrink-0 flex-nowrap bg-[#1a7bb3] rounded-[12px] relative z-[49]">
            <span className="flex w-[118px] h-[25px] justify-end items-start shrink-0 basis-auto font-['Vazirmatn'] text-[16px] font-semibold leading-[25px] text-[#fff] relative text-right whitespace-nowrap z-50">
              در حال ارسال کد...
            </span>
          </div>
          <div className="flex gap-[4px] justify-center items-center self-stretch shrink-0 flex-nowrap relative z-[51]">
            <span className="flex w-[78px] h-[22px] justify-end items-start shrink-0 basis-auto font-['Vazirmatn'] text-[14px] font-semibold leading-[21.875px] text-[#2094e3] relative text-right underline whitespace-nowrap z-[52]">
              ثبت‌نام شرکت
            </span>
            <span className="flex w-[154px] h-[22px] justify-end items-start shrink-0 basis-auto font-['Vazirmatn'] text-[14px] font-normal leading-[21.875px] text-[#718096] relative text-right whitespace-nowrap z-[53]">
