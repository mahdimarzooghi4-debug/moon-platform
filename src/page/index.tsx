  ...
  return (
    <div dir="ltr" className="main-container mx-auto flex h-[1100px] w-[1440px] flex-nowrap items-start bg-[#f4f6f8]">
      <main className="flex h-[1100px] min-w-0 flex-1 flex-col items-start gap-[24px] px-[40px] pb-[40px] pt-[24px]">
        ...
        <section className="flex h-[64px] w-[1069px] shrink-0 items-center justify-between">
          <div className="flex h-[64px] w-[1069px] shrink-0 flex-col items-end gap-[6px] text-right">
            <h1 dir="rtl" className="h-[38px] whitespace-nowrap text-[24px] font-extrabold leading-[38px] text-[#17324d]">کتابخانه رسانه</h1>
            <p dir="rtl" className="h-[20px] w-full whitespace-nowrap text-right text-[13px] font-normal leading-[20px] text-[#60758a]">محدودیت دسترسی به فایل‌ها و گواهی‌های انتشار</p>
          </div>
        </section>
        ...
        <section className="flex min-h-[500px] w-full min-w-0 flex-1 flex-col items-center justify-center gap-[20px] rounded-[20px] border border-[#e4ebf1] bg-white p-[48px]" style={{ boxShadow: "0 4px 16px rgba(23, 46, 71, 0.08)" }}>
          <div className="flex size-[80px] shrink-0 items-center justify-center rounded-full bg-[#fef3c7]">
            <img src="/assets/mah/media-lock.svg" alt="" className="size-[40px]" />
          </div>
          <h2 dir="rtl" className="whitespace-nowrap text-right text-[20px] font-bold leading-[31px] text-[#17324d]">به کتابخانه رسانه دسترسی ندارید</h2>
          <p dir="rtl" className="whitespace-nowrap text-center text-[14px] font-normal leading-[22px] text-[#60758a]">حساب کاربری شما اجازه دسترسی به منابع عمومی و چندرسانه‌ای سامانه ماه را ندارد. لطفا با مدیر سیستم تماس بگیرید.</p>
          <MahButton label="بازگشت به داشبورد CMS" />
        </section>
      </main>
