  ...
  return (
    <div className="creative-house-dashboard bg-[#f5f8fb] relative w-full h-full" data-node-id="1788:2" data-name="ayeneh-milestone-evaluation-detail">
      <div className="absolute bg-[#f5f8fb] h-[1900px] left-0 overflow-clip top-0 w-[1216px]" data-node-id="1788:232" data-name="Main Content">
        <a className="absolute bg-white block border border-[#e4ebf1] border-solid cursor-pointer h-[36px] left-[28px] overflow-clip rounded-[10px] top-[24px] w-[142px]" data-node-id="1788:287" data-name="back-to-list">
        ...
        <div className="absolute bg-white border border-[#e4ebf1] border-solid h-[720px] left-[28px] overflow-clip rounded-[16px] shadow-[0px_4px_16px_0px_rgba(23,46,71,0.08)] top-[208px] w-[356px]" data-node-id="1788:306" data-name="milestone-evaluation-decision">
          ...
          <button className="absolute bg-[#eaf8f0] block cursor-pointer h-[40px] left-[17px] overflow-clip rounded-[10px] top-[393px] w-[320px]" data-node-id="1788:325" data-name="decision-option">
          ...
          <button className="absolute bg-[#fff7e8] block cursor-pointer h-[40px] left-[17px] overflow-clip rounded-[10px] top-[443px] w-[320px]" data-node-id="1788:327" data-name="decision-option">
          ...
          <button className="absolute bg-[#fdeeee] block cursor-pointer h-[40px] left-[17px] overflow-clip rounded-[10px] top-[493px] w-[320px]" data-node-id="1788:329" data-name="decision-option">
          ...
          <a className="absolute bg-[#2094e3] block cursor-pointer h-[38px] left-[17px] overflow-clip rounded-[10px] top-[667px] w-[320px]" data-node-id="1788:334" data-name="save-decision">
        ...
        <div className="absolute bg-white border border-[#e4ebf1] border-solid h-[1650px] left-[400px] overflow-clip rounded-[16px] shadow-[0px_4px_16px_0px_rgba(23,46,71,0.08)] top-[208px] w-[760px]" data-node-id="1788:339" data-name="milestone-report-data">
          ...
          <button className="absolute bg-white block border border-[#e4ebf1] border-solid cursor-pointer h-[52px] left-[13px] overflow-clip rounded-[10px] top-[1027px] w-[732px]" data-node-id="1788:422" data-name="document-row">
          ...
          <button className="absolute bg-white block border border-[#e4ebf1] border-solid cursor-pointer h-[52px] left-[13px] overflow-clip rounded-[10px] top-[1089px] w-[732px]" data-node-id="1788:428" data-name="document-row">
          ...
          <button className="absolute bg-white block border border-[#e4ebf1] border-solid cursor-pointer h-[52px] left-[13px] overflow-clip rounded-[10px] top-[1151px] w-[732px]" data-node-id="1788:434" data-name="document-row">
          ...
          <button className="absolute bg-white block border border-[#e4ebf1] border-solid cursor-pointer h-[52px] left-[13px] overflow-clip rounded-[10px] top-[1213px] w-[732px]" data-node-id="1788:440" data-name="document-row">
      ...
      <div className="absolute bg-[#17324d] content-stretch flex flex-col gap-[10px] h-[1900px] items-end left-[1216px] pb-[18px] pt-[20px] px-[16px] top-0 w-[224px]" data-node-id="1788:233" data-name="colored-sidebar">
        ...
        <a className="content-stretch cursor-pointer flex gap-[10px] h-[38px] items-center justify-end overflow-clip px-[12px] relative rounded-[9px] shrink-0 w-[192px]" data-node-id="1788:238" data-name="dashboard-nav">
        ...
        <a className="content-stretch cursor-pointer flex gap-[10px] h-[38px] items-center justify-end overflow-clip px-[12px] relative rounded-[9px] shrink-0 w-[192px]" data-node-id="1788:245" data-name="startup-evaluations-nav">
        ...
        <a className="content-stretch cursor-pointer flex gap-[10px] h-[38px] items-center justify-end overflow-clip px-[12px] relative rounded-[9px] shrink-0 w-[192px]" data-node-id="1788:252" data-name="project-evaluations-nav">
        ...
        <a className="content-stretch cursor-pointer flex gap-[10px] h-[38px] items-center justify-end overflow-clip px-[12px] relative rounded-[9px] shrink-0 w-[192px]" data-node-id="1788:262" data-name="reports-nav">
        ...
        <a className="content-stretch cursor-pointer flex gap-[10px] h-[38px] items-center justify-end overflow-clip px-[12px] relative rounded-[9px] shrink-0 w-[192px]" data-node-id="1788:269" data-name="evaluation-history-nav">
        ...
        <a className="content-stretch cursor-pointer flex gap-[10px] h-[38px] items-center justify-end overflow-clip px-[12px] relative rounded-[9px] shrink-0 w-[192px]" data-node-id="1788:275" data-name="settings-nav">
        ...
        <button className="bg-white content-stretch cursor-pointer flex gap-[10px] h-[38px] items-center justify-end opacity-96 overflow-clip px-[12px] relative rounded-[9px] shrink-0 w-[192px]" data-node-id="1788:281" data-name="logout-nav">
