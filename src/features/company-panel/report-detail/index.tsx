      ...
      <main className="company-report-detail-page" dir="rtl">
        <header className="company-topbar company-report-detail-topbar">
          ...
          <div className="company-top-actions">
            <Link className="company-action company-action-primary company-report-download" to={`/projects/impact-report/print?source=company&reportId=${encodeURIComponent(reportId)}`}>دریافت گزارش</Link>
